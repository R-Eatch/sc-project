...
dir_name <- 'D:/111/HVGs-MG-AG/'
dataset <- 'R-MG R-AG'
# --- 2. 读取数据 ---
go_file <- paste0(dir_name,"R.MG...R.AG_GO_Result.csv")
kegg_file <- paste0(dir_name,"R.MG...R.AG_KEGG_Result.csv")
...
p_base <- ggplot() +
  ...
  # 标题
  labs(
    title = paste0("GO/KEGG Enrichment Results for HVGs ",dataset)
  ) +
  # 居中轴线
