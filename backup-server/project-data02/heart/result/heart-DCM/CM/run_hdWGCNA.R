...
reduction <- 'harmony'
spefic_celltype <- 'Cardiomyocytes'#Cardiomyocytes,Smooth_Muscle,Fibroblasts Smooth_Muscle
resultpath <- './result'
RDSpath <- '../../../data/heart_Fib_Cardio_Smooth_DCM.rds'#heart_Fib_Cardio_Smooth_Donor.rds heart_Fib_Cardio_Smooth_DCM.rds
dataset <- 'DCM'#DCM DON
n_genes <- 5
nThreads <- 4
soft_power <- NULL
