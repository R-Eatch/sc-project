...
DATASETS <- list(
  heart = list(
    ...
    datExpr_csv = "../data/heart/heart_datExpr_samplesXgenes_VST.csv",
    outdir      = "./result/WGCNA_heart",
  ...
  lung = list(
    datExpr_csv = "../data/lung_pao/lung_pao_datExpr_samplesXgenes_VST.csv",
    outdir      = "./result/WGCNA_lung_pao",
