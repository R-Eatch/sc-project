...
dataset <- "R-CG"
cores <- 1
s.genes <- c("Prlr",'Esr1',"Epcam",'Acta2','Lalba','Elf5','Esr1','Lef1','Krt23','Pip')
brunch_gene <- s.genes
subset_celltype <- c("ASC", "Epi-Pro", "Lum-Krt8", "LumSEC-Hmgcr", "LumSEC-Lip-E", "Epi-Fibro", "Epi-Sbsn", "Lum-Ppl", "LumSEC-Lip", "LumSEC-MG-like")
root_state <- 3 #for ordercells
subset_clusters <- c()
...
use_ordergene <- "~stage"
use_hvg=TRUE
use_seurat_hvgs = FALSE
ifsubsetcelltype <- FALSE
ifselect_number <- TRUE
color_dict <- c(
