...
vars_use=['sample']
NewCellType = {
    "Basal/Myoepithelial Cells": [0],
    "Adipocytes / Metabolic Cells": [1],
    "Keratinocytes": [2],
    "Fibroblasts / ECM-producing Cells": [3],
    "Cycling Cells / Proliferating Cells": [4],
    "Luminal Ductal Cells": [5],
    "Luminal Alveolar Cells": [6],
    "Mesenchymal Stem Cells / Vascular-like Cells": [7],
    "Metabolic / Steroid-producing Cells": [8]
}
...
Featuregenes = [
    'Postn', 'Myh11', 'Spp1', 'Acta2',  # Basal/Myoepithelial Cells
    'Abcb11', 'Fabp3', 'Fdx1', 'Dhdh',  # Adipocytes / Metabolic Cells
    'Pla2g12b', 'Pla2g2c', 'Hal', 'Slc46a2',  # Keratinocytes
    'Nuggc', 'C1qtnf3', 'Serpinf2', 'Pcdh17',  # Fibroblasts / ECM-producing Cells
    'Ccnb1', 'Ccnb2', 'Ube2c', 'Mpl',  # Cycling Cells / Proliferating Cells
    'Atp6v0d2', 'Tmprss11e', 'Klk9', 'Gabrp',  # Luminal Ductal Cells
    'Afm', 'Pip', 'Kmo', 'Wfdc3',  # Luminal Alveolar Cells
    'Sncb', 'Crabp1', 'Pdgfra', 'Shox2',  # Mesenchymal Stem Cells / Vascular-like Cells
    'Sephs1', 'Dhdh', 'Fdx1', 'Sult2b1'  # Metabolic / Steroid-producing Cells
]
