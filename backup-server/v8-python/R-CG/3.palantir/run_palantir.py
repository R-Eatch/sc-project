...
terminal_states = pd.Series(
    ["LumSEC-AG-t1","LumSEC-AG-t2",'Basal','Lum-MG-like','Lum-Esr+'],
    index=["S-AG-GES14-GGGAGTAAGGGTGAGG", "S-AG-8M-3-GACCTTCCATCATTGG",'S-AG-GES14-AGTAGCTCAGAGTCAG','S-AG-LA-2-GGGTGTCAGAATCTAG','S-AG-LA-1-TTTCCTCCACGGTAGA'],
)
terminal_states = pd.Series(
    ["LumSEC-CG",'Basal'],
    index=["R-CG-GES30-CTGATCCGTGTATCCA", "R-CG-GES17-AGATGCTCACCGCTAG"],
)
genes = 'Top2a,Lef1,Epcam,Acta2,Lalba,Elf5,Esr1,Prlr'
subset_cluster = ''
root_cell_id = 'R-CG-E26-TTAGGCAGTATGAGAT'
n_genes = 30
drop_cells=True
droplist=['Lum-Fib-like','Lum-Imm-like','Lum-Adi-like','Lum-Ker-like']
cores=8
...
def plot_umap_without_borders(ea, dataset, color="palantir_pseudotime"):
    """
