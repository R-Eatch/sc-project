...
Featuregenes = [
    ...
    'Aqp3','Shh','Atp1a1','Atp1b1','Procr','Wnt6'，'Krt5','Trp63','Lgr5','Krt5'
]
...
if __name__ == "__main__":
    ...
    # Replace X with adata.layers['counts'] if available
    if 'counts' not in adata_raw.layers:
        print("Warning: 'counts' layer not found in the data. Please check your h5ad.")
    else:
        print("Replacing adata.X with adata.layers['counts']...")
