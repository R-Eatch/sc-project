...
NewCellType = {
    ...
    "Luminal Ductal Cells": [1],
    "Luminal Alveolar Cells": [2],
    "Keratinocytes": [3],
...
Featuregenes = [
    'Acta2', 'Actg2', 'Stra6', 'Adra1d',  # Basal/Myoepithelial Cells
    'Smpd3', 'Pkib', 'Ovgp1', 'Cadm2',      # Luminal Ductal Cells
    'Lalba', 'Pla2g1b', 'Gnmt', 'Cym',       # Luminal Alveolar Cells
    'Sbsn', 'Krt1', 'Serpinb2', 'Rbp2',       # Keratinocytes
    'Fxyd2', 'Foxi1', 'Ankrd1', 'Cldn10',     # Mammary Progenitor-like Cells
    'Igfbp1', 'Sfrp2', 'Rspo3', 'Lum',         # Fibroblasts
    'Avpr1a', 'Cysltr1', 'Colec10', 'Gja4',    # Vascular Cells
    'Ube2c', 'Top2a', 'Ccnb1', 'Mad2l1',       # Cycling Cells
    'Icos', 'Ccr7', 'Ms4a1', 'Ltb',           # B Cells
    'S100b', 'Cdh19', 'Cnmd', 'Gldn',          # Schwann Cells
    'Leap2', 'Capn6', 'Slc6a3', 'Adipoq',       # Adipocytes
    'Myod1', 'Myf5', 'Pax7', 'Myf6',           # Muscle Cells
]
