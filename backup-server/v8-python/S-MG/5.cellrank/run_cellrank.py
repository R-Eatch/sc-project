...
dataset = 'S-MG'
cores = 8
terminal_states = ['LumHR','LumSEC-Lac']
initial_state='MaSC'
n_genes = 50
pseudotime='pseudotime' #'palantir_pseudotime' or 'dpt_pseudotime'
...
adata_pala = ad.read_h5ad('/data01/sunxuebo/project/scrnaseq/v8-python/S-MG/9.stage_DEG/S-MG_cleaned_pse.h5ad')
