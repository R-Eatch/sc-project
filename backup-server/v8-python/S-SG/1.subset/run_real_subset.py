...
vars_use=['sample']
NewCellType = {
    # 结合“duct progenitor”相关基底标记 (Krt5, Krt14, Trp63, Col17a1, Itga6, Sox9)
    "DuctProgenitor": [0, 3, 5, 13],
    
    # 结合“duct luminal / secretory”标记 (Krt7, Scnn1a/b/g, Slc12a2, Car6 等)
    "DuctLuminal_Secretory": [6, 7, 9, 12],
    
    # 肌上皮 (myoepithelial) / 平滑肌标记 (Myh11, Acta2, Des, Myl9...)
    "Myoepithelial": [3, 4, 8],
    
    # 角质形成细胞 (Krt1, Krt2, Krt10, Krt17, Cdsn 等)
    "Keratinocyte": [1, 2, 3, 4, 6, 7, 11, 13],
    
    # 成纤维细胞 (Fibroblast) / 间质 (Col1a1, Col1a2, Pdgfra, Lum, Dcn...)
    "Fibroblast": [0, 3, 8, 10],
    
    # 施旺细胞 / 神经 (Mpz, Plp1, Sox10, Tubb3, Snap25...)
    "Schwann_Neuronal": [2, 4, 10],
    
    # 如果有尚未归类或标记不明显的 cluster，可加一个 "Unknown": [...]
}
