...
def clean_h5ad(dataset,df,sp,obslist):
    adata=sc.read_h5ad(f"/data01/sunxuebo/project/scrnaseq/v8-python/samap/samap-go/samap-all-allcell/split/{dataset}_ori.h5ad")
    if sp == 'ms':
...
obslist=['celltype','gland','species','stage_new','sample','stage_old']
