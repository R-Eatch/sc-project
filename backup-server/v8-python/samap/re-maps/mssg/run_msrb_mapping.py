...
# 输入文件路径
blast_file = "ms_to_sg.txt"
output_file = "ms_to_sg1.txt"
query_mapping_file = "/data01/sunxuebo/project/scrnaseq/v8-python/samap/M.gene_mapping.csv"
subject_mapping_file = ""

# 是否替换query_protein和subject_protein
replace_query = True  # 设置为 False 禁用 query_protein 的替换
replace_subject = False  # 设置为 False 禁用 subject_protein 的替换
