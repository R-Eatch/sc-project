...
# 输入文件路径
blast_file = "sg_to_rb.txt"
output_file = "sg_to_rb1.txt"
query_mapping_file = ""
subject_mapping_file = "/data01/sunxuebo/project/scrnaseq/v8-python/samap/R.gene_mapping.csv"

# 是否替换query_protein和subject_protein
replace_query = False  # 设置为 False 禁用 query_protein 的替换
