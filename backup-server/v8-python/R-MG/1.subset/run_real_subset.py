...
vars_use=['sample']
NewCellType = {
    "Luminal Alveolar Cells": [0],
    "Basal Epithelial Cells": [1],
    "Fibroblasts": [2],
    "Plasma Cells": [3],
    "Mammary Progenitor-like Cells": [4],
...
Featuregenes = [
    'Pigr', 'Btn1a1', 'Lao1', 'Adgrf1',  # Luminal Alveolar Cells
    'Acta2', 'Col9a2', 'Il13ra2', 'Ecrg4',  # Basal Epithelial Cells
    'Prokr2', 'Zic3', 'Alx3', 'Shox2',  # Fibroblasts
    'Mzb1', 'Gpr15', 'Txndc5', 'Tnfrsf17',  # Plasma Cells
    'Shh', 'Wnt10b', 'Wnt3a', 'Lhx2',  # Mammary Progenitor-like Cells
    'Stc2', 'Cplx3', 'Acsm3', 'Lman1l',  # Luminal Ductal Cells
    'Krt77', 'Mt4', 'Flg2', 'Sbsn',  # Keratinocytes
    'Rergl', 'Myocd', 'Cox4i2', 'Higd1b',  # Vascular Cells
    'Myf5', 'Mstn', 'Pax7', 'Myod1',  # Muscle Cells
    'Mgp', 'Clu', 'Spp1', 'Fhod3',  # Mesenchymal Stem Cells
    'Ccnb1', 'Mpl', 'Aspm', 'Hmmr',  # Cycling Cells
    'Prf1', 'Cd2', 'Icos', 'Klrk1',  # T Cells
    'Cdh19', 'Mpz', 'Gpr37l1', 'Cldn19',  # Schwann Cells
    'Rxfp2', 'Cdh9', 'Nrxn1', 'Slc6a15',  # Neural Cells
]
random.seed(2024)
np.random.seed(2024)
cells = 5000
