...
dataset = 'R-MG'  # sample name, will affect input/output file names
...
Featuregenes = [
    ...
    'Aqp3','Shh','Atp1a1','Atp1b1','Procr','Wnt6','Trp63','Lgr5','Krt5','Pip','Sox9','Sox10','Areg','Krt7','Krt23'
]
