...
dataset = 'M-MG'
cores = 8
terminal_states = ['LumSEC type1_1','LumSEC type2','LumHR']
initial_state='StemCells type1_2'
n_genes = 50
pseudotime='palantir_pseudotime' #'palantir_pseudotime' or 'dpt_pseudotime'
n_states=[6,12]##macrostates##
...
for cellname in terminal_states:
    ...
    cell_drivers.to_csv(f'{dataset}-{cellname}-driver-gene.csv')
