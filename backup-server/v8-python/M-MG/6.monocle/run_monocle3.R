...
#############电脑上操作#############
if(FALSE){
  cds <- load_monocle_objects(directory_path=paste0('D:/Data/',dataset,'_cds_for_subset.rds'))
  ...
  save_monocle_objects(cds=cds_subset, directory_path=paste0('D:/Data/',dataset,'_subset_cds.rds'))
}
#######################################
...
if(file.exists(paste0(dataset,'_subset_cds.rds'))){
  ...
  ggsave(paste0(dataset, "_m3_pseudotime.pdf"), p1, width = 15, height = 10)
