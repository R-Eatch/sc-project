...
dataset = 'M-MG'  # sample name, will affect input/output file names
...
Featuregenes = [
    ...
    'Aqp3','Shh','Atp1a1','Atp1b1','Procr','Wnt6','Krt5','Trp63','Lgr5','Krt5','Pip','Sox9','Sox10','Areg','Krt7','Krt23','Pip'
]
...
def do_umap_plots(adata, sample_prefix="sample", feature_genes=None, do_feature=False):
    ...
    if do_feature and feature_genes is not None:
        sc.pl.umap(
            adata,
            color=[*feature_genes,'newcelltype','subtype',"stage",'sample','leiden','gland'],
            wspace=0.5,
            size=3,
            ncols=4,
