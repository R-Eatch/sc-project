...
#     "Orther Epithelial":["Epi-Fibro", "Epi-Krt7", "Epi-Lgals7","Lum-Basal", "Lum-Immune", "Lum-Kit"],
#     "MaSC":["MaSC", "MaSC-Pro", "MaSC-t2-sg"]
# }
NewCellType = {
    "Basal":["Basal"],
    "Luminal SEC":["LumSEC-AG-Pip", "LumSEC-AG-t1", "LumSEC-AG-t2", "LumSEC-Lip-CG"],
    "Orther Epithelial":["Epi-Fibro", "Epi-Hmgcr", "Epi-Krt7", "Epi-Lalba", "Epi-Lgals7",
    "Epi-Lip", "Epi-Pro", "Lum-Stat4", "Lum-Tm4sf4",],
    "ASCs":["ASC-rb", "ASC-sg", "CSC",]
}
Featuregenes = ['Epcam','Prlr','Pgr','Esr1','Ar','Elf5','Lalba','Pip','Krt1','Krtdap','Sbsn']
doFeatureplot = True
runharmony = True
