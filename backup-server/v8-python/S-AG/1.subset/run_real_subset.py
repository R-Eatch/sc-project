...
vars_use=['sample']
NewCellType = {
    "Luminal Alveolar Cells": [0, 9],
    "Adipocytes": [1, 13],
    "Keratinocytes": [2, 3],
    "Basal/Myoepithelial Cells": [4, 14],
    "Muscle Cells": [5, 16],
    "Luminal Ductal Cells": [6, 7],
    "Vascular Cells": [8],
    "Fibroblasts": [10],
    "Cycling Cells": [11],
    "Schwann Cells": [12, 15]
...
Featuregenes = [
    'Lalba', 'Elf5', 'Prlr', 'Clu',          # Luminal Alveolar Cells
    'Elovl3', 'Fabp5', 'Plin2', 'Cidea',      # Adipocytes
    'Krt1', 'Krt10', 'Tgm1', 'Casp14',        # Keratinocytes
    'Myh11', 'Des', 'Acta2', 'Tpm2',          # Basal/Myoepithelial Cells
    'Pax7', 'Myf5', 'Myod1', 'Myf6',          # Muscle Cells
    'Pip', 'Pigr', 'Cckar', 'Foxa3',          # Luminal Ductal Cells
    'Gja4', 'Myh11', 'Flt1', 'Abcc9',         # Vascular Cells
    'Lum', 'Dcn', 'Tnmd', 'Sfrp2',             # Fibroblasts
    'Top2a', 'Melk', 'Kif20b', 'Cdk1',         # Cycling Cells
    'Cdh19', 'Prdm8', 'Adcyap1', 'Olfm1',
'Krt5','Acta2','Krt17'        # Schwann Cells
]
