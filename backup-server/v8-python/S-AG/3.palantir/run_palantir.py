...
terminal_states = pd.Series(
    ["LumSEC-Lip","LumSEC-MG-like",'LumSEC-Hmgcr','Lum-Krt8','Lum-Ppl'],
    index=["S-AG-LA-1-TAACTTCGTACCGTGC", "S-AG-LA-1-GAGGGATGTGAATAAC",'S-AG-3MTH-1-CTAACCCGTCCGTTTC','S-AG-LA-2-CAACCTCCAGCTGTAT','S-AG-GES14-AGGGAGTGTCGTACAT'],
)
genes = 'Top2a,Lef1,Epcam,Acta2,Lalba,Elf5,Esr1,Prlr'
subset_cluster = ''
root_cell_id = 'S-AG-3MTH-1-ACTGCAAAGACGTCCC'
n_genes = 30
drop_cells=False
