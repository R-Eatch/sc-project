...
Featuregenes = ["EPCAM", "KRT7", "KRT5", "PIP",
    "ELF5", "LALBA", "PRLR", "ESR1", "GLI2",
    "PLET1", "DSG3", "PIP", "CAVIN3","KRT18","KRT14","KIT","KRT7","LTF"
]
Featuregenes = [ "PIGR",
    "SLC28A3",
    "ARHGEF38",
...
def do_umap_plots(adata, sample_prefix="sample", feature_genes=None, do_feature=False):
    ...
    if do_feature and feature_genes is not None:
        ...
        sc.pl.umap(
            ...
            size=3,
            ncols=4,
            save=f'{sample_prefix}_feature_umap.png',gene_symbols='feature_name'
        )
...
def do_deg(adata, sample_prefix="sample"):
    ...
    sc.tl.rank_genes_groups(adata, groupby='author_cell_type', method='wilcoxon')
