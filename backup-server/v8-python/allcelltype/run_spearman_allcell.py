...
celltype_column = 'stage_new'
gland_column = 'species'
n_top_genes=2000
...
adata.obs['stage_new'] = (adata.obs['species'].astype(str) + '-' +  adata.obs[celltype_column].astype(str))
#adata = adata[adata.obs['stage_new'] == 'stage2'].copy()
# In[ ]:
