...
vars_use=['sample']
NewCellType = {
    # 管腔基底/祖细胞（Duct Basal Progenitors）
    "Duct_Basal_Progenitor": [1, 3, 5],
    
    # 管腔细胞（Luminal Duct Cells）
    "Luminal_Duct_Cells": [4, 8],
    
    # 肌上皮（Myoepithelial）
    "Myoepithelial": [7, 9],
    
    # 角质形成细胞（Keratinocytes）
    "Keratinocyte": [2, 6, 12],
    
    # 施旺细胞 / 神经元样细胞（Schwann / Neuronal）
    "Schwann_Neuronal": [10],
    
    # 暂未明确分类或可能为低丰度/高增殖等其他类型
    "prolif": [0, 11]
}
