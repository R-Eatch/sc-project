...
dataset = 'M-EG'  # sample name, will affect input/output file names

#h5adpath = f'{dataset}_for_DEG.h5ad'  # path to read the h5ad file
h5adpath = f'M-SG_for_DEG.h5ad'  # path to read the h5ad file
