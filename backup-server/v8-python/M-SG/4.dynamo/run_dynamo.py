...
stem = 'Lum-EDCs'
cell1 = 'Lum-SDCs'
cell2 = 'LumAlv-MG-like'
good_fixed_points = [14,12,13]
...
def plot_lap(paths):
    ...
    ax = dyn.pl.streamline_plot(
        adata, basis="umap", save_show_or_return="return", ax=ax, color="newcelltype", frontier=True
    )
    ax = ax[0]
    x, y = 0, 1
