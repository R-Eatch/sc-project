...
terminal_states = pd.Series(
    ["LumSEC-MG","LumHR",'Basal'],
    index=["M-MG-LA-1-AAGCGTTAGCCGTAAG", "M-MG-GES13_5-CTTCCTTGTCTACGTA",'M-MG-LA-2-GACCAATGTGTTAAAG'],
)
genes = 'Top2a,Lef1,Epcam,Acta2,Lalba,Elf5,Esr1,Prlr'
subset_cluster = ''
root_cell_id = 'M-MG-E13_5-GCGTGCAAGGAGTCTG'
n_genes = 30
drop_cells=True
