...
mapping_dict = {'S-MG-3MTH': 'S-3MTh-MG-v','S-MG-8M-3': 'S-8M-MG-3-v','S-MG-8M-4': 'S-8M-MG-4-v','S-MG-GES14': 'S-GES14-MG','S-MG-LA-1': 'S-LA14-MG','S-MG-LA-2': 'S-LA-MG-2-v','S-MG-P20': 'S-P20-MG-v','S-MG-P7': 'S-P7-MG-v'}
#mapping_dict = { 'S-AG-3MTH-1': 'SG-AG-1Mth-1-v','S-AG-3MTH-2': 'SG-AG-1Mth-2-v','S-AG-8M-2': 'S-8m-AG-2-v','S-AG-8M-3': 'S-8m-AG-3-v','S-AG-GES14': 'S-GES14-AG', 'S-AG-LA-1': 'SG-LA-AG-1-v','S-AG-LA-2': 'SG-LA-AG-2-v', 'S-AG-P20': 'S-P20-AG-v'}
...
adata_path = f'../{dataset}_nohomo.h5ad'
adata_noh_path = f'/data01/sunxuebo/project/scrnaseq/v9-nohomo/{dataset}/{dataset}_nohomo.h5ad'
...
for key,value in mapping_dict.items():
    loom_filename = f'/data01/sunxuebo/project/scrnaseq/v8-python/data/loom/{key}.loom'
...
adata_noh = sc.read_h5ad(adata_noh_path)
...
if run_geneconvert:
    df_sg = pd.DataFrame({
    "sg": adata_noh.var["gene_ids"],
    "Gene name": adata_noh.var_names
})
    ldata = gene_convert(ldata=ldata,df=df_sg)
...
print(adata1)
adata1.write(f'{dataset}_for_filter.h5ad')
