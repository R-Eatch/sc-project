...
scv.pl.velocity_embedding_stream(adata1, basis='umap',color='gland',save=f'./{dataset}_velo.png')
scv.pl.velocity_embedding_stream(adata1, basis='umap',color='newcelltype',save=f'./{dataset}_velo-newcelltype.png')

# In[27]:


scv.pl.proportions(adata1,groupby='stage',save=f'./{dataset}_proportions.png')
