...
dataset = 'R-AG'  # sample name, will affect input/output file names
...
Featuregenes = [
    'ESR1', 'EPCAM', 'TOP2A', 'ACTA2', 'LYZG', 'LEF1', 'KRT23', 'ELF5', 'TCF4', 'KRT1', 'PRL-R', 'AR', 'PIGR','KRT8','KRT18-1','KRT14','KRT5',
    'CD69', 'ADIPOQ', 'LUM', 'PGR', 'VIM', 'PTPRC',
    'FAAH', 'TM4SF1', 'PPL', 'WNT11', 'KRTDAP', 'SBSN', 'DSP', 'RAB25',
    'AQP3', 'SHH', 'ATP1A1', 'ATP1B1', 'PROCR', 'WNT6', 'KRT5', 'TP63', 'LGR5', 'KRT5',
    'SOX10', 'AREG','CLDN1','CDH1','KRT16','KRT15'

]
Featuregenes = [
    'ESR1', 'EPCAM', 'TOP2A', 'ACTA2', 'LYZG', 'LEF1', 'KRT23', 'ELF5', 'TCF4', 'KRT1', 'AR', 'PIGR','KRT5', 'AREG','CLDN1','CDH1','KRT16','KRT15'
]
